...
sector:`energy`Energy`materials`industrials`financials`healthcare`utilities`infotech
...
T:`t
Z:`z
G:`trader`strategy`symbol`date`time
F:`N_`sector`pnl`price`wprice`quantity
A:()!()
A[`N_]:(count;`price)
